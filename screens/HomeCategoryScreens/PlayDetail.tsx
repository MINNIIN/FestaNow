...
type PlayDetailScreenNavigationProp = StackNavigationProp<RootStackParamList, 'PlayDetail'>;

type Props = {
  navigation: PlayDetailScreenNavigationProp;
  route: any; // route.params.id 사용하려면 정확한 타입도 설정 가능
};

const PlayDetail = ({ route, navigation }: Props) => {
