...
type MusicalDetailScreenNavigationProp = StackNavigationProp<RootStackParamList, 'MusicalDetail'>;

type Props = {
  navigation: MusicalDetailScreenNavigationProp;
  route: any; // route.params.id 사용하려면 정확한 타입도 설정 가능
};

const MusicalDetail = ({ route, navigation }: Props) => {
